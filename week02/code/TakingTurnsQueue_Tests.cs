...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: enqueue method added to beginning of queue not end of queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: getNextPerson() did not add 0 turn people back into the queue
    ...
    // Defect(s) Found: tweak GetNextPerson() to not infinitely decrease number of turns
